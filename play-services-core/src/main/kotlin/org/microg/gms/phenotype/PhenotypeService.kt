...
class PhenotypeServiceImpl : IPhenotypeService.Stub() {
    ...
    override fun getConfigurationSnapshot(
        callbacks: IPhenotypeCallbacks,
        p1: String?,
        p2: String?
    ) {
    ...
    override fun getExperimentTokens(
        callbacks: IPhenotypeCallbacks,
        p1: String?,
    ...
    override fun getConfigurationSnapshot2(
        callbacks: IPhenotypeCallbacks,
        p1: String?,
        p2: String?,
        p3: String?
    ...
    override fun setFlagOverrides(
        ...
        Log.d(
            TAG,
            "setFlagOverrides($packageName, $user, $flagName, $flagDataType, $flagType, $flagDataType, $flagValue)"
        )
        callbacks.onFlagOverridesSet(Status.SUCCESS)
    }

    override fun deleteFlagOverrides(
        callbacks: IPhenotypeCallbacks,
        packageName: String?,
        user: String?,
        flagName: String?
    ...
    override fun listFlagOverrides(
        callbacks: IPhenotypeCallbacks,
        packageName: String?,
        user: String?,
        flagName: String?
    ...
    override fun clearFlagOverrides(
        callbacks: IPhenotypeCallbacks,
        packageName: String?,
        user: String?
    ) {
    ...
    override fun setAppSpecificProperties(
        callbacks: IPhenotypeCallbacks,
        p1: String?,
        p2: ByteArray?
    ) {
    ...
    override fun getExperimentTokens2(
        callbacks: IPhenotypeCallbacks,
        p1: String?,
        p2: String?,
        p3: String?,
