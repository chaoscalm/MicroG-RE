...
private class NetworkDroidGuardResultCreator(private val context: Context) :
    DroidGuardResultCreator {
...
private class EmbeddedDroidGuardResultCreator(private val context: Context) :
    DroidGuardResultCreator {
    override suspend fun getResults(flow: String, data: Map<String, String>): String {
